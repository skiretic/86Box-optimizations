...
codegen_MMX_ENTER(codeblock_t *block, uop_t *uop)
{
    ...
    /* Fast-path: already in MMX mode and CR0.TS clear -> skip tag rewrites */
    host_arm64_LDRB_IMM_W(block, REG_TEMP, REG_CPUSTATE, (uintptr_t) &cpu_state.ismmx - (uintptr_t) &cpu_state);
    host_arm64_TST_IMM(block, REG_TEMP, 1);
    branch_ismmx_ptr = host_arm64_BNE_(block);
    ...
    host_arm64_branch_set_offset(branch_ismmx_ptr, &block->data[block_pos]);
...
codegen_PACKSSWB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_b) && uop->dest_reg_a_real == uop->src_reg_a_real) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PACKSSWB not supported on generic ARM64\n");
        }
#else
        fatal("PACKSSWB not supported on this platform\n");
#endif
    } else
...
codegen_PACKSSDW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_b) && uop->dest_reg_a_real == uop->src_reg_a_real) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PACKSSDW not supported on generic ARM64\n");
        }
#else
        fatal("PACKSSDW not supported on this platform\n");
#endif
    } else
...
codegen_PACKUSWB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_b) && uop->dest_reg_a_real == uop->src_reg_a_real) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PACKUSWB not supported on generic ARM64\n");
        }
#else
        fatal("PACKUSWB not supported on this platform\n");
#endif
    } else
...
codegen_PSHUFB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSHUFB not supported on generic ARM64\n");
        }
#else
        fatal("PSHUFB not supported on this platform\n");
#endif
    } else
...
codegen_PADDB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDB not supported on generic ARM64\n");
        }
#else
        fatal("PADDB not supported on this platform\n");
#endif
    }
...
codegen_PADDW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDW not supported on generic ARM64\n");
        }
#else
        fatal("PADDW not supported on this platform\n");
#endif
    }
...
codegen_PADDD(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDD not supported on generic ARM64\n");
        }
#else
        fatal("PADDD not supported on this platform\n");
#endif
    }
...
codegen_PADDSB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDSB not supported on generic ARM64\n");
        }
#else
        fatal("PADDSB not supported on this platform\n");
#endif
    }
...
codegen_PADDSW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDSW not supported on generic ARM64\n");
        }
#else
        fatal("PADDSW not supported on this platform\n");
#endif
    }
...
codegen_PADDUSB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDUSB not supported on generic ARM64\n");
        }
#else
        fatal("PADDUSB not supported on this platform\n");
#endif
    }
...
codegen_PADDUSW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PADDUSW not supported on generic ARM64\n");
        }
#else
        fatal("PADDUSW not supported on this platform\n");
#endif
    }
...
#else
        fatal("PCMPEQB not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PCMPEQW not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PCMPEQD not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PCMPGTB not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PCMPGTW not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PCMPGTD not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PF2ID not supported on this platform\n");
#endif
    } else
        fatal("PF2ID %02x\n", uop->dest_reg_a_real);
...
#else
        fatal("PFADD not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PFCMPEQ not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PFCMPGE not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PFCMPGT not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PFMAX not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PFMIN not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PFMUL not supported on this platform\n");
#endif
    } else
...
codegen_PFRCP(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PFRCP not supported on generic ARM64\n");
        }
#else
        fatal("PFRCP not supported on this platform\n");
#endif
    } else
        fatal("PFRCP %02x\n", uop->dest_reg_a_real);
...
codegen_PFRSQRT(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PFRSQRT not supported on generic ARM64\n");
        }
#else
        fatal("PFRSQRT not supported on this platform\n");
#endif
    } else
        fatal("PFRSQRT %02x\n", uop->dest_reg_a_real);
...
#else
        fatal("PFSUB not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PI2FD not supported on this platform\n");
#endif
    } else
        fatal("PI2FD %02x\n", uop->dest_reg_a_real);
...
codegen_PSLLW_IMM(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSLLW_IMM not supported on generic ARM64\n");
        }
#else
        fatal("PSLLW_IMM not supported on this platform\n");
#endif
    } else
...
codegen_PSLLD_IMM(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSLLD_IMM not supported on generic ARM64\n");
        }
#else
        fatal("PSLLD_IMM not supported on this platform\n");
#endif
    } else
...
codegen_PSLLQ_IMM(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSLLQ_IMM not supported on generic ARM64\n");
        }
#else
        fatal("PSLLQ_IMM not supported on this platform\n");
#endif
    } else
...
codegen_PSUBB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBB not supported on generic ARM64\n");
        }
#else
        fatal("PSUBB not supported on this platform\n");
#endif
    }
...
codegen_PSUBW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBW not supported on generic ARM64\n");
        }
#else
        fatal("PSUBW not supported on this platform\n");
#endif
    }
...
codegen_PSUBD(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBD not supported on generic ARM64\n");
        }
#else
        fatal("PSUBD not supported on this platform\n");
#endif
    }
...
codegen_PSUBSB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBSB not supported on generic ARM64\n");
        }
#else
        fatal("PSUBSB not supported on this platform\n");
#endif
    }
...
codegen_PSUBSW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBSW not supported on generic ARM64\n");
        }
#else
        fatal("PSUBSW not supported on this platform\n");
#endif
    }
...
codegen_PSUBUSB(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBUSB not supported on generic ARM64\n");
        }
#else
        fatal("PSUBUSB not supported on this platform\n");
#endif
    }
...
codegen_PSUBUSW(codeblock_t *block, uop_t *uop)
{
    ...
    if (REG_IS_Q(dest_size) && REG_IS_Q(src_size_a) && REG_IS_Q(src_size_b)) {
        ...
        if (codegen_backend_is_apple_arm64()) {
            ...
            fatal("PSUBUSW not supported on generic ARM64\n");
        }
#else
        fatal("PSUBUSW not supported on this platform\n");
#endif
    }
...
#else
        fatal("PUNPCKHBW not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PUNPCKHWD not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PUNPCKHDQ not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PUNPCKLBW not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PUNPCKLWD not supported on this platform\n");
#endif
    } else
...
#else
        fatal("PUNPCKLDQ not supported on this platform\n");
#endif
    } else
