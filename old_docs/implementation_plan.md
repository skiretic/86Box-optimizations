...
*   **Direct byte emission**: Machine code bytes are written to a buffer via `addbyte()`, `addword()`, `addlong()`, `addquad()` macros.
...
| File | Purpose |
| :--- | :--- |
| vid_voodoo_codegen_arm64.h | **[NEW]** ARM64/NEON codegen implementation |
